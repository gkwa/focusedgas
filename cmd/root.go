...
import (
	...
	"github.com/gkwa/focusedgas/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.focusedgas.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".focusedgas")
	}
